// ================================================================
// Vendor Export Service - Clean CSV Format
// Generates vendor-grouped order exports with specific formatting
// ================================================================
...
export class VendorExportService {
  ...
  // Get operator ID from multi-tenant system
  getOperatorId() {
    return 'mopped-bbq-dev'; // Should come from your operator config
  }
...
// await exportService.exportOrdersByVendor(locationId);
