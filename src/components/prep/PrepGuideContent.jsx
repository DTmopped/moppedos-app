  ...
  return (
    <div className="space-y-4">
      {dailyShiftPrepData.map((day, idx) => {
        ...
        return (
          <div key={idx} className="border border-slate-300 rounded-lg shadow-sm">
            <button
              onClick={() => toggleDay(day.date)}
              className="w-full flex items-center justify-between px-4 py-3 bg-slate-100 hover:bg-slate-200 rounded-t-lg transition"
            >
              <div>
            ...
            {isExpanded && (
              <div className="px-4 py-4 bg-white space-y-4 border-t border-slate-200">
                {["am", "pm"].map((shiftKey) => {
                  ...
                  return (
                    <div
                      key={shiftKey}
                      className="bg-slate-100 border border-slate-300 rounded-md p-4"
                    >
                        ...
                        <table className="w-full text-sm border-collapse">
                          <thead>
                            <tr className="text-slate-500 border-b border-slate-300">
                              ...
                              <th className="py-1 text-left">Assigned To</th>
