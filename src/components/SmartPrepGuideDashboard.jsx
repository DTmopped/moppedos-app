...
import { useSmartPrepGuide } from './useSmartPrepGuide';
import { RESTAURANT_TEMPLATES } from './SmartPrepGuideConfig';

const SmartPrepGuideDashboard = () => {
  const {
    smartPrepData,
    adjustmentFactor,
    printDate,
...
export default SmartPrepGuideDashboard;
