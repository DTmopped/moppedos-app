...
const BriefingInputSection = ({
  ...
  return (
    <Card className="bg-card/80 dark:bg-card/70 border-border/50">
      <CardHeader>
        <CardTitle
          className={`text-lg text-foreground flex items-center ${
        ...
        {fields.map((field) =>
          field.type === "textarea" ? (
            <Textarea
              ...
              className="text-sm font-mono bg-background/70 dark:bg-background/50 focus:border-primary transition-all duration-300 placeholder:text-muted-foreground"
