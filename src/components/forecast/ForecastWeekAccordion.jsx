...
const ForecastWeekAccordion = ({ week, amSplit }) => { 
  ...
  return (
    <AccordionItem className="border bg-white rounded-lg shadow-sm mb-2 transition-shadow hover:shadow-md">
      <AccordionTrigger 
        onClick={handleClick}
        isOpen={isOpen}
        className="px-4 py-3 text-sm font-semibold text-gray-800 hover:no-underline rounded-lg data-[state=open]:rounded-b-none"
      >
      ...
      <AccordionContent isOpen={isOpen} className="px-4 pb-4 bg-gray-50 rounded-b-lg">
