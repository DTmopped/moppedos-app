    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="space-y-6">
      <div className="grid grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-slate-500">MTD Forecasted Sales</p>
            <p className="text-lg font-semibold text-slate-800">${mtd.forecastSales.toLocaleString()}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-slate-500">MTD Actual Sales</p>
            <p className="text-lg font-semibold text-green-700">${mtd.actualSales.toLocaleString()}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-slate-500">MTD Sales Variance</p>
            <p className="text-lg font-semibold text-red-600">${(mtd.actualSales - mtd.forecastSales).toLocaleString()}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-slate-500">EOM Forecasted Sales</p>
            <p className="text-lg font-semibold text-purple-700">${eom.forecastSales.toLocaleString()}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-slate-500">
              MTD Avg Food Cost %{" "}
              <span className="text-xs text-slate-400">(Goal: {(foodTarget * 100).toFixed(0)}%)</span>
            </p>
        ...
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-slate-500">
              MTD Avg Beverage Cost %{" "}
              <span className="text-xs text-slate-400">(Goal: {(bevTarget * 100).toFixed(0)}%)</span>
            </p>
        ...
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-slate-500">
              MTD Avg Labor Cost %{" "}
              <span className="text-xs text-slate-400">(Goal: {(laborTarget * 100).toFixed(0)}%)</span>
            </p>
