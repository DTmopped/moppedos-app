  ...
  useEffect(() => {
    const fetchAllForecasts = async () => {
      ...
      if (error) {
        ...
        // Set the accordion for the currently active week to be open by default on load
    ...
    fetchAllForecasts();
    // *** FIX: Add all dependencies that the effect relies on ***
  }, [locationId, activeWeekStartDate]);
