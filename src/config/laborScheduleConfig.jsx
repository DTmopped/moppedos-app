...
// Complete 13-role structure with AM, MID, PM shifts added
export const ROLES = [
  ...
  { 
    ...
    department: "FOH", 
    hourly_rate: 16.50, 
    colorClass: "bg-green-200 text-green-800 dark:bg-green-700 dark:text-green-100 print:bg-green-100" 
  },
  { 
    name: "Server", 
    abbreviation: "SRV", 
  ...
  { 
    ...
    department: "FOH", 
    hourly_rate: 15.50, 
    colorClass: "bg-sky-200 text-sky-800 dark:bg-sky-700 dark:text-sky-100 print:bg-sky-100" 
  },
  { 
    name: "Busser", 
    abbreviation: "BUS", 
...
export const SHIFT_BG_CLASSES = {
  ...
  MID: "bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100 print:bg-green-100",
