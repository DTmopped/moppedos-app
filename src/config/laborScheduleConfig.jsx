...
export const ROLES = [
  ...
  { name: "Bartender", abbreviation: "BAR", ratio: 150, shifts: ["PM"], minCount: 1, colorClass: "bg-indigo-200 text-indigo-800 dark:bg-indigo-700 dark:text-indigo-100 print:bg-indigo-100" }
];
