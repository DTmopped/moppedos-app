...
const BriefingFormField = ({ id, label, type = "text", placeholder, value, onChange, options, minHeight }) => {
  return (
    <div className="space-y-1.5">
      ...
      {type === "textarea" ? (
        ...
        <Select value={value} onValueChange={onChange}>
          <SelectTrigger id={id} className="w-full bg-background/70 dark:bg-background/60 focus:border-primary text-sm">
